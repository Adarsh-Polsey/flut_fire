        ...
        child: Center(
          child: Padding(
           ...
           Expanded(child: Image.network("https://media.istockphoto.com/id/1210010868/video/young-businessman-working-with-laptop.jpg?s=640x640&k=20&c=4zyaTIpj7gRaBhZwIur0GGYyo5YvI9r5MYRK8mpbgm4=")),
              SizedBox(height: 30,),
              ButtonWidget(text: "Login",bgColor: Colors.white,onPressed: (){Navigator.pushReplacementNamed(context,'/Login');print("worked");}),
              SizedBox(height: 20,),
              ButtonWidget(text: "Sign Up",bgColor: Colors.blue,onPressed: (){Navigator.pushReplacementNamed(context, "/SignUp");}),
            ],),
          ),
        ),
      ),
